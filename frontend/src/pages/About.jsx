...
const About = () => {
  ...
  return (
    <>
       <section className='w-full ml-0 m-0 h-fit px-5 pt-10 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-2 justify-center'>
      <div>
       <h1 className='text-[#d6482b] text-2xl font-bold mb-1 min-[380px]:text-3xl md:text-4xl xl:text-5xl 2xl:text-8xl'>About Us</h1>
       <p className='text-xl text-stone-600'>
            Welcome to NextBid,The ultimate destination for the Online auction and bidding excitement.
            Founded in 2025, we are dedeicated to providing a dynamic and the user-friendly platform 
            for buyers and sellers to connect,explore,and transact in a secure and seamless environment.
       ...
       <div>
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Krishna Rinke, NextBid was born out of a passion for
