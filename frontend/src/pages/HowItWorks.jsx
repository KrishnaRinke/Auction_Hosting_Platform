...
import{
 FaUser,FaGavel,FaEnvelope,FaDollarSign,FaFileInvoice,FaRedo
} from "react-icons/fa" 
...
const HowItWorks = () => {
  ...
  return (
    <>
       ...
       <h1 className='text-[#d6482b] text-2xl font-bold mb-1 min-[380px]:text-3xl md:text-4xl xl:text-5xl 2xl:text-8xl'>Discover How NextBid Operates</h1>
                ...
                steps.map((element,index)=>{
                    return(
                        <div key={index} className='bg-white rounded-md p-2 lg:p-5 flex flex-col gap-2 group hover:bg-black transition-all duration-300'>
                             <div className='bg-black text text-white p-3 text-xl rounded-full w-fit group-hover:bg-[#d6482b] transition-all duration-300'>
                                {element.icon}
                             </div>
