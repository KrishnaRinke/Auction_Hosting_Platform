...
const Login = () => {
  ...
  return (
    <>
       ...
       <h1 className='text-[#d6482b] text-2xl font-bold mb-1 min-[380px]:text-3xl md:text-4xl xl:text-5xl 2xl:text-8xl'> Login</h1>
        ...
        <form onSubmit={handleLogin} className='flex flex-col gap-5 w-full'>
            ...
            <button className='bg-[#d6482b] font-semibold hover:bg-[#b8381e] transition-all duration-300 text-xl py-2 px-1 rounded-md text-white w-[150px] mx-auto my-4' type='submit'> {loading ? "Logging In..." : "Login" }</button>
        </form>
