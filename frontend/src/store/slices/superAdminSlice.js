...
const superAdminSlice = createSlice({
    ...
    reducers:{
       ...
       successForAllUsers(state,action){
        state.loading = false;
        totalAuctioneer=action.payload.auctioneersArray,
        totalBidders=action.payload.biddersArray;
       },
      ...
      state.totalAuctioneer = state.totalAuctioneer;
...
export const getMonthlyRevenue = () => async (dispatch) =>{
    ...
    try {
        const response = await axios.get("http://localhost:4000/api/v1/superadmin/monthlyincome",{withCredentials:true})
        dispatch(superAdminSlice.actions.successForMonthlyRevenue(
...
export const getAllUsers = () => async (dispatch) =>{
    ...
    try {
        const response = await axios.get("http://localhost:4000/api/v1/superadmin/users/getall",{withCredentials:true})
        dispatch(superAdminSlice.actions.successForAllUsers(
            response.data
        ));
    } catch (error) {
...
export const getAllPaymentProofs = () => async (dispatch) =>{
    ...
    try {
        const response = await axios.get("http://localhost:4000/api/v1/superadmin/paymentproofs/getall",{withCredentials:true})
        dispatch(superAdminSlice.actions.successForPaymentProofs(
...
export const deletePaymentProofs = (id) => async (dispatch) =>{
    dispatch(superAdminSlice.actions.requestForDeletePaymentProof());
    try {
        const response = await axios.delete(`http://localhost:4000/api/v1/superadmin/paymentproof/delete/${id}`,{withCredentials:true})
...
export const getSinglePaymentProofDetail = (id) => async (dispatch) =>{
    ...
    try {
        const response = await axios.get(`http://localhost:4000/api/v1/superadmin/paymentproof/${id}`,{withCredentials:true})
...
export const updatePaymentProof = (id,status,amount) => async (dispatch) =>{
    ...
    try {
        const response = await axios.put(`http://localhost:4000/api/v1/superadmin/paymentproof/status/update/${id}`,{status,amount},{withCredentials:true,headers:{"Content-Type":"application/json"}})
...
export const deleteAuctionItem = (id) => async (dispatch) =>{
    ...
    try {
        const response = await axios.put(`http://localhost:4000/api/v1/superadmin/auctionitem/delete/${id}`,{withCredentials:true})
