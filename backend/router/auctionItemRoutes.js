import { addNewAuctionItem, getAllItems, getAuctionDetails, getMyAuctionsItems, removeFromAuction, republishItem } from "../controllers/auctionItemController.js";
...
router.get("/myitems",isAuthenticated,isAuthorized("Auctioneer"),getMyAuctionsItems);
